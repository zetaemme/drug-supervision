...
\begin{document}
	...
	\section{UML}
		...
		\safeImage[\textwidth]{Package_Model.png}
		\safeImage[\textwidth]{Package_Utils.png}
		\safeImage[\textwidth]{View-Controller_Class_Diagram.png}

		\subsection{Sequence Diagram}
		\safeImage[0.8\textwidth]{SD_Login.png}
		\safeImage[0.8\textwidth]{SD_I_Paziente.png}
		\safeImage[0.8\textwidth]{SD_I_Report.png}
		\safeImage[0.8\textwidth]{SD_Cancella.png}		
		\safeImage[0.8\textwidth]{SD_V_Report.png}
